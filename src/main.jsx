...
import { VerificarEmprestimos } from './pages/VerificarEmprestimos';
...
const rotas = createBrowserRouter(
  createRoutesFromElements(
    <>
      ...
      <Route path="/verificarEmprestimos" element={<VerificarEmprestimos />} />
      ...
      <Route path="/emprestimo3/:isbn/:idautor" element={<Emprestimo3/>}/>
    </>
  )
);
